...
| 33  |                               | Scales, axes, and legends               | VISU.4                |                |
| 34  |                               | Multi-view composition                  | VISU.5                |                |
| 35  |                               | Interaction                             | VISU.6                |                |
| 36  | Text analytics                | Syntax: tokenization and POS tagging    | WEB.9                 |                |
| 37  |                               | Semantics: sentiment and named entities | WEB.11                |                |
| 38  | Network analytics             | Basic network concepts                  | NETS.1                |                |
| 39  |                               | Network structure                       | NETS.2                |                |
| 40  |                               | Network content and structure           | WEB.10                |                |
| 41  | Machine learning              | Introduction to machine learning        | PDSH.5.1, PDSH.5.2    |                |
